...
import RNPicjerSelect from 'react-native-picker-select';
...
const CreateRecord = () => {
  ...
  const handleSubmit = () => {
    const plaload = { name, age, gameId: selectedGame };

    axios.post(`${BASE_URL}/records`, plaload)
      .then(() => {
      ...
      .catch(() => Alert.alert('Erro ao salvara as informações!'))
  }
